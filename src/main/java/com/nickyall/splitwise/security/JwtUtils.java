...
public class JwtUtils {
    ...
    private long jwtExpirationMs = 10000000;
    private final String jwtCookie = "nikcookie";
    ...
    public ResponseCookie generateJwtCookie(UserDetailsImpl userPrincipal) {
        String jwt = generateTokenFromEmail(userPrincipal.getEmailId());
    ...
    private Key key() {
        ...
        byte[] keyBytes = "ThisIsASampleSecretKeyForTestingPurposes".getBytes();
    ...
    public String generateTokenFromEmail(String emailId) {
        return Jwts.builder()
                .setSubject(emailId)
